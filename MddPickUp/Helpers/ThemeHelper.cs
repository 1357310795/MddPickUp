...
namespace MddPickUp.Helpers
{
    public static class ThemeHelper
    {
        ...
        internal static void ApplyAdjustment()
        {
            ...
            {
                internalTheme.ColorAdjustment = new ColorAdjustment() { Colors = ColorSelection.Primary, DesiredContrastRatio = 4.5f, Contrast = Contrast.Medium };
            }
            paletteHelper.SetTheme(theme);
        }
    ...
    public static class PaletteHelperExtensions
    {
        public static void ChangePrimaryColor(this PaletteHelper paletteHelper, Color color)
        {
            ...
            theme.SecondaryLight = new ColorPair(theme.SecondaryLight.Color, Colors.White);
            theme.SecondaryMid = new ColorPair(theme.SecondaryMid.Color, Colors.White);
            theme.SecondaryDark = new ColorPair(theme.SecondaryDark.Color, Colors.White);
