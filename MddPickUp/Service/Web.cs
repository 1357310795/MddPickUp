...
using static MddPickUp.Models.WebResult;

namespace MddPickUp.Service
{
    public static class Web
    {
        public static CommonResult Post(string url, Dictionary<string, string> headers, Dictionary<string, string> formdata)
        {
            #region 构造表单数据
        ...
        public static CommonResult Post(string url, Dictionary<string, string> headers, string formdata)
        {
            #region 初始化请求
            HttpWebRequest req = (HttpWebRequest)WebRequest.Create(url);
            req.Method = "POST";
